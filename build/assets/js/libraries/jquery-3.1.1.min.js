!function(a, b) {
    ...
    function pa(a, b, c, d, e) {
        for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++) if ((f = a[n]) || 0 === f) if ("object" === r.type(f)) r.merge(m, f.nodeType ? [ f ] : f); else if (oa.test(f)) {
            for (g = g || l.appendChild(b.createElement("div")), h = (ja.exec(f) || [ "", "" ])[1].toLowerCase(), 
            i = la[h] || la._default, g.innerHTML = i[1] + r.htmlPrefilter(f) + i[2], k = i[0]; k--; ) g = g.lastChild;
            r.merge(m, g.childNodes), (g = l.firstChild).textContent = "";
        } else m.push(b.createTextNode(f));
        for (l.textContent = "", n = 0; f = m[n++]; ) if (d && r.inArray(f, d) > -1) e && e.push(f); else if (j = r.contains(f.ownerDocument, f), 
        g = ma(l.appendChild(f), "script"), j && na(g), c) for (k = 0; f = g[k++]; ) ka.test(f.type || "") && c.push(f);
        return l;
    }
    function ua() {
        return !0;
    ...
    function xa(a, b, c, d, e, f) {
        ...
        d = void 0) : (e = d, d = c, c = void 0)), !1 === e) e = va; else if (!e) return a;
    ...
    function Ia(a, b, c, d) {
        ...
        f || d)) {
            for (i = (h = r.map(ma(e, "script"), Ea)).length; l < m; l++) j = e, l !== n && (j = r.clone(j, !0, !0), 
    ...
    function Na(a, b, c) {
        ...
        return (c = c || Ma(a)) && ("" !== (g = c.getPropertyValue(b) || c[b]) || r.contains(a.ownerDocument, a) || (g = r.style(a, b)), 
    ...
    function Ua(a) {
        if (a in Ta) return a;
        for (var b = a[0].toUpperCase() + a.slice(1), c = Sa.length; c--; ) if ((a = Sa[c] + b) in Ta) return a;
    }
    function Va(a, b, c) {
        var d = aa.exec(b);
    ...
    function Xa(a, b, c) {
        ...
        if (a.getClientRects().length && (d = a.getBoundingClientRect()[b]), d <= 0 || null == d) {
            if (((d = Na(a, b, f)) < 0 || null == d) && (d = a.style[b]), La.test(d)) return d;
    ...
    function fb(a, b, c) {
        ...
        c.queue || (null == (g = r._queueHooks(a, "fx")).unqueued && (g.unqueued = 0, h = g.empty.fire, 
        ...
        if ((i = !r.isEmptyObject(b)) || !r.isEmptyObject(n)) {
            ...
            null == (j = q && q.display) && (j = V.get(a, "display")), "none" === (k = r.css(a, "display")) && (j ? k = j : (ha([ a ], !0), 
            j = a.style.display || j, k = r.css(a, "display"), ha([ a ]))), ("inline" === k || "inline-block" === k && null != j) && "none" === r.css(a, "float") && (i || (m.done(function() {
                o.display = j;
    ...
    function gb(a, b) {
        ...
        f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), (g = r.cssHooks[d]) && "expand" in g) {
    ...
    function hb(a, b, c) {
        var d, e, f = 0, g = hb.prefilters.length, h = r.Deferred().always(function() {
            ...
            if (e) return !1;
            for (var b = Za || cb(), c = Math.max(0, j.startTime + j.duration - b), f = 1 - (c / j.duration || 0), g = 0, i = j.tweens.length; g < i; g++) j.tweens[g].run(f);
    ...
    var c = [], d = a.document, e = Object.getPrototypeOf, f = c.slice, g = c.concat, h = c.push, i = c.indexOf, j = {}, k = j.toString, l = j.hasOwnProperty, m = l.toString, n = m.call(Object), o = {}, q = "3.1.1", r = function(a, b) {
    ...
    var x = function(a) {
        ...
        function ta(a, b, c) {
            ...
            return b.first ? function(b, c, e) {
                ...
                } else for (;b = b[d]; ) if (1 === b.nodeType || g) if (l = b[u] || (b[u] = {}), 
                ...
                CHILD: function(a, b, c, d, e) {
                    ...
                    return 1 === d && 0 === e ? function(a) {
                        ...
                        if (q) {
                            ...
                            j = k[a] || [], n = j[0] === w && j[1], t = n), !1 === t) for (;(m = ++n && m && m[p] || (t = n = 0) || o.pop()) && ((h ? m.nodeName.toLowerCase() !== r : 1 !== m.nodeType) || !++t || (s && (l = m[u] || (m[u] = {}), 
    ...
    r.event = {
        ...
        add: function(a, b, c, d, e) {
            ...
            if (q) for (c.handler && (f = c, c = f.handler, e = f.selector), e && r.find.matchesSelector(qa, e), 
            ...
            }), j = (b = (b || "").match(K) || [ "" ]).length; j--; ) h = ta.exec(b[j]) || [], 
            n = p = h[1], o = (h[2] || "").split(".").sort(), n && (l = r.event.special[n] || {}, 
            n = (e ? l.delegateType : l.bindType) || n, l = r.event.special[n] || {}, k = r.extend({
                type: n,
                origType: p,
                data: d,
                handler: c,
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (q && (i = q.events)) {
                for (j = (b = (b || "").match(K) || [ "" ]).length; j--; ) if (h = ta.exec(b[j]) || [], 
        ...
        this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && !1 === a.returnValue ? ua : va, 
        ...
        off: function(a, b, c) {
            ...
            return !1 !== b && "function" != typeof b || (c = b, b = void 0), !1 === c && (c = va), 
            this.each(function() {
    ...
    r.extend({
        ...
        clone: function(a, b, c) {
            ...
            return (g = ma(h, "script")).length > 0 && na(g, !i && ma(a, "script")), h;
        },
        ...
        html: function(a) {
            return S(this, function(a) {
                ...
                if ("string" == typeof a && !za.test(a) && !la[(ja.exec(a) || [ "", "" ])[1].toLowerCase()]) {
                    a = r.htmlPrefilter(a);
                    try {
                        for (;c < d; c++) 1 === (b = this[c] || {}).nodeType && (r.cleanData(ma(b, !1)), 
                        b.innerHTML = a);
                        b = 0;
                    } catch (e) {}
                }
    ...
    r.extend({
        ...
        style: function(a, b, c, d) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                void 0 === c ? g && "get" in g && void 0 !== (e = g.get(a, !1, d)) ? e : i[b] : ("string" === (f = typeof c) && (e = aa.exec(c)) && e[1] && (c = ea(a, b, e), 
        ...
        css: function(a, b, c, d) {
            ...
            return b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h), (g = r.cssHooks[b] || r.cssHooks[h]) && "get" in g && (e = g.get(a, !0, c)), 
            void 0 === e && (e = Na(a, b, d)), "normal" === e && b in Ra && (e = Ra[b]), "" === c || c ? (f = parseFloat(e), 
    ...
    r.Animation = r.extend(hb, {
        ...
        for (Za = r.now(); b < c.length; b++) (a = c[b])() || c[b] !== a || c.splice(b--, 1);
    ...
    r.fn.extend({
        ...
        attr: function(a, b, c) {
            ...
            if (3 !== f && 8 !== f && 2 !== f) return void 0 === a.getAttribute ? r.prop(a, b, c) : (1 === f && r.isXMLDoc(a) || (e = r.attrHooks[b.toLowerCase()] || (r.expr.match.bool.test(b) ? ib : void 0)), 
    ...
    r.fn.extend({
        ...
        addClass: function(a) {
            ...
            if ("string" == typeof a && a) for (b = a.match(K) || []; c = this[i++]; ) if (e = nb(c), 
            d = 1 === c.nodeType && " " + mb(e) + " ") {
                for (g = 0; f = b[g++]; ) d.indexOf(" " + f + " ") < 0 && (d += f + " ");
                e !== (h = mb(d)) && c.setAttribute("class", h);
            }
            return this;
        },
        ...
        toggleClass: function(a, b) {
            ...
            return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : r.isFunction(a) ? this.each(function(c) {
                ...
                var b, d, e, f;
                if ("string" === c) for (d = 0, e = r(this), f = a.match(K) || []; b = f[d++]; ) e.hasClass(b) ? e.removeClass(b) : e.addClass(b); else void 0 !== a && "boolean" !== c || ((b = nb(this)) && V.set(this, "__className__", b), 
                this.setAttribute && this.setAttribute("class", b || !1 === a ? "" : V.get(this, "__className__") || ""));
            });
        },
        hasClass: function(a) {
            var b, c, d = 0;
            for (b = " " + a + " "; c = this[d++]; ) if (1 === c.nodeType && (" " + mb(nb(c)) + " ").indexOf(b) > -1) return !0;
            return !1;
        }
    });
    var ob = /\r/g;
    r.fn.extend({
        val: function(a) {
            ...
            })) : e ? (b = r.valHooks[e.type] || r.valHooks[e.nodeName.toLowerCase()], b && "get" in b && void 0 !== (c = b.get(e, "value")) ? c : (c = e.value, 
            "string" == typeof c ? c.replace(ob, "") : null == c ? "" : c)) : void 0;
        }
    }), r.extend({
        valHooks: {
            option: {
            ...
            select: {
                get: function(a) {
                    ...
                    for (d = f < 0 ? i : g ? f : 0; d < i; d++) if (((c = e[d]).selected || d === f) && !c.disabled && (!c.parentNode.disabled || !r.nodeName(c.parentNode, "optgroup"))) {
    ...
    r.extend(r.event, {
        trigger: function(b, c, e, f) {
            ...
            n = r.event.special[p] || {}, f || !n.trigger || !1 !== n.trigger.apply(e, c))) {
                ...
                r.event.triggered = p, e[p](), r.event.triggered = void 0, i && (e[k] = i)), b.result;
            }
        },
    ...
    Ib.href = qb.href, r.extend({
        ...
        ajax: function(b, c) {
            function A(b, c, d, h) {
                ...
                j ? (o.ifModified && ((w = y.getResponseHeader("Last-Modified")) && (r.lastModified[f] = w), 
            ...
            (l = r.event && o.global) && 0 == r.active++ && r.event.trigger("ajaxStart"), o.type = o.type.toUpperCase(), 
            o.hasContent = !Db.test(o.type), f = o.url.replace(zb, ""), o.hasContent ? o.data && o.processData && 0 === (o.contentType || "").indexOf("application/x-www-form-urlencoded") && (o.data = o.data.replace(yb, "+")) : (n = o.url.slice(f.length), 
            o.data && (f += (sb.test(f) ? "&" : "?") + o.data, delete o.data), !1 === o.cache && (f = f.replace(Ab, "$1"), 
    ...
    r.ajaxSetup({
        ...
        setOffset: function(a, b, c) {
            ...
            i = r.css(a, "left"), ("absolute" === k || "fixed" === k) && (f + i).indexOf("auto") > -1 ? (d = l.position(), 
